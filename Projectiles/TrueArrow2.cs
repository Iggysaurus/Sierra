...
{
    public class TrueArrow2 : ModProjectile 
    {
        ...
        {
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("TrueBoom2"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
